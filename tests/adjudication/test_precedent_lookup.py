...
from sports_signal_bot.adjudication.precedents import PrecedentRegistry, PrecedentLookupEngine
...
def test_precedent_lookup():
    ...
    prec = PrecedentRecord(
        ...
        applicable_scope=KnowledgeScopeRecord(scope_type=KnowledgeScopeType.single_entity, target_value="m1"),
