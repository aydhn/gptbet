import pytest
from sports_signal_bot.geo_hardening.active_active import build_active_active_rehearsal, detect_rehearsal_divergence
from sports_signal_bot.geo_hardening.rehearsal_symmetry import compute_rehearsal_symmetry, detect_dual_writer_risk, classify_divergence_severity
