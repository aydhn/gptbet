import pytest
from sports_signal_bot.geo_hardening.integration import build_geo_operational_matrix, validate_geo_operational_row, summarize_geo_operational_matrix
...
def test_operational_matrix():
    ...
    matrix = validate_geo_operational_row(matrix, {"owner": "test", "freshness_note": "ok"})
