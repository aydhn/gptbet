from sports_signal_bot.source_selection.contracts import SourceEligibilityRecord, SourceExclusionReasonRecord
...
def test_exclusion_reason_record():
    ...
    rec = SourceEligibilityRecord(event_id="e", sport="s", market_type="m", source_name="s", source_family="f")
