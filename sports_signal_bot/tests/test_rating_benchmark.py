...
def test_rating_benchmark_football_1x2():
    ...
    snapshot = RatingSnapshotRecord(
        ...
        home_team_id="A",
        away_team_id="B",
        pre_home_rating=1600.0,
        pre_away_rating=1500.0,
        expected_home_score=0.64,
        expected_away_score=0.36,
    )
...
def test_rating_benchmark_basketball_moneyline():
    ...
    snapshot = RatingSnapshotRecord(
        ...
        home_team_id="A",
        away_team_id="B",
        pre_home_rating=1400.0,
        pre_away_rating=1600.0,
        expected_home_score=0.24,
        expected_away_score=0.76,
    )
    ...
    assert (
        round(pred.predicted_probabilities["1"] + pred.predicted_probabilities["2"], 5)
        == 1.0
    )
