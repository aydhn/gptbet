...
def test_build_leaderboard():
    s1 = EvaluationSummaryRecord(
        source_name="Model_A", source_family="ml", sport="football", market_type="1x2",
        row_count=100, coverage_rate=1.0, log_loss=0.65, brier=0.20, accuracy=0.55
    )
    s2 = EvaluationSummaryRecord(
        source_name="Model_B", source_family="benchmark", sport="football", market_type="1x2",
        row_count=100, coverage_rate=1.0, log_loss=0.70, brier=0.22, accuracy=0.50
    )
