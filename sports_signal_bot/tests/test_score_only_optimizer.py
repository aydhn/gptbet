import pytest
from sports_signal_bot.thresholds.strategies.score_only import ScoreOnlyThresholdOptimizer
...
def test_score_only_optimizer():
    optimizer = ScoreOnlyThresholdOptimizer({"score_threshold_bounds": [0.4, 0.6], "grid_steps": 3})
