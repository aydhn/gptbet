import pytest
from sports_signal_bot.data.normalization.names import normalize_team_name, normalize_league_name
from sports_signal_bot.data.normalization.markets import normalize_market_name, safe_decimal_odds, implied_prob_from_decimal_odds
...
def test_team_resolver(tmp_path):
    ...
    assert resolver.resolve_team_name("Man Utd", "football", "premier_league") == "Manchester United"
    assert resolver.resolve_team_name("Unknown Team", "football", "premier_league") == "Unknown Team"
