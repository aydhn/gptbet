...
from sports_signal_bot.policy.contracts import (PolicyLifecycleRecord,
                                                PolicySignalStatus)
...
class LifecycleManager:
    ...
    def get_allowed_transitions() -> Dict[PolicySignalStatus, List[PolicySignalStatus]]:
        return {
            ...
            PolicySignalStatus.BELOW_THRESHOLD: [PolicySignalStatus.EXPIRED],
            PolicySignalStatus.NO_BET_ZONE: [
                PolicySignalStatus.EXPIRED,
                PolicySignalStatus.OVERRIDDEN,
            ],
            PolicySignalStatus.BLOCKED: [PolicySignalStatus.OVERRIDDEN],
            PolicySignalStatus.REJECTED: [],
            PolicySignalStatus.INVALID: [],
            PolicySignalStatus.EXPIRED: [],
            PolicySignalStatus.OVERRIDDEN: [],
    ...
    def is_transition_valid(
        current: PolicySignalStatus, target: PolicySignalStatus
    ) -> bool:
