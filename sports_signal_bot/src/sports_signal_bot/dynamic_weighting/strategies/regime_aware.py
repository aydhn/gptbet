...
from sports_signal_bot.dynamic_weighting.components import compute_base_prior, compute_trust_weight_component, compute_regime_weight_component, combine_weight_components
    ...
    def compute_weights(self, eligible_sources: List[Dict[str, Any]], context: Dict[str, Any]) -> List[DynamicWeightRecord]:
        ...
        for source in eligible_sources:
            ...
            components = combine_weight_components(
                trust=trust, regime=regime, disagreement=0.0, recency=0.0, health=1.0,
