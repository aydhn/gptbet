...
from sports_signal_bot.probabilistic.football.contracts import LambdaBuildContext, FootballProbabilityRecord
from sports_signal_bot.probabilistic.football.lambda_builder import GoalLambdaBuilder
...
from sports_signal_bot.probabilistic.football.correct_score import CorrectScoreExtractor
...
class FootballPoissonModel:
    ...
    def predict(self, context: LambdaBuildContext, features: Dict[str, float]) -> List[FootballProbabilityRecord]:
        ...
        records.append(FootballProbabilityRecord(
