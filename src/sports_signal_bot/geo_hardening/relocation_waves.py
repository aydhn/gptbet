...
def build_archive_relocation_wave(
    wave_id: str, family: str
) -> ArchiveRelocationWaveRecord:
...
def verify_relocation_wave_replay_support(
    wave: ArchiveRelocationWaveRecord, replay_id: str
):
    wave.replay_refs.append(replay_id)
    return True


def summarize_archive_relocation_wave(
    wave: ArchiveRelocationWaveRecord,
) -> Dict[str, Any]:
    return {
