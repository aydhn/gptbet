...
def build_active_active_rehearsal(rehearsal_id: str, family: str) -> ActiveActiveRehearsalRecord:
...
def detect_rehearsal_divergence(rehearsal: ActiveActiveRehearsalRecord, divergence_id: str):
    rehearsal.divergence_refs.append(divergence_id)
    rehearsal.rehearsal_status = "rehearsal_caveated"
    return rehearsal

def summarize_active_active_rehearsal(rehearsal: ActiveActiveRehearsalRecord) -> Dict[str, Any]:
    return {
