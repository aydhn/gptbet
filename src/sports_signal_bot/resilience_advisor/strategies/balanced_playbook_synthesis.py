...
class BalancedPlaybookSynthesisStrategy(BaseResilienceAdvisorStrategy):
    ...
    def synthesize_advice(self, incident_signals: Dict[str, Any]) -> AdvisoryRecommendationRecord:
        ...
        return AdvisoryRecommendationRecord(
            ...
            why_this_pattern_match="Balanced pattern matching and evidence",
            remaining_risks=["standard_execution_risks"]
        )
