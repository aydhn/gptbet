...
from .contracts import (
    CutoverHandoffRecord,
    CutoverLagRecord,
    CutoverMismatchRecord,
    CutoverRollbackReadinessRecord,
    CutoverRollbackStepRecord,
    CutoverScopeRecord,
    CutoverWaveFamily,
    CutoverWaveRecord,
    CutoverWaveWarningRecord,
)
...
def verify_wave_rollback_readiness(
    readiness: list[CutoverRollbackReadinessRecord],
) -> bool:
    return True
