...
class LiveFireVisibilityExerciseFamily(str, Enum):
    ...
    sovereignty_visibility_live_fire_exercise = (
        "sovereignty_visibility_live_fire_exercise"
    )
    ...
    cross_region_visibility_live_fire_exercise = (
        "cross_region_visibility_live_fire_exercise"
    )
    continuity_visibility_live_fire_exercise = (
        "continuity_visibility_live_fire_exercise"
    )
...
class FailoverCheckpointFamily(str, Enum):
    ...
    sovereignty_visibility_verified_checkpoint = (
        "sovereignty_visibility_verified_checkpoint"
    )
...
class LiveFireVisibilityExerciseParams(BaseModel):
