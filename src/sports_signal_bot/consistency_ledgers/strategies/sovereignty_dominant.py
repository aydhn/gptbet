...
class SovereigntyDominantConsistencyStrategy(BaseConsistencyLedgerStrategy):
    ...
    def apply_federation_rules(
        ...
        federation.warnings.append(
            "Sovereignty-Dominant: Alignment outputs fast-tracked to cap"
        )
        return federation
    ...
    def apply_clearing_rules(
        ...
        clearer.warnings.append(
            "Sovereignty-Dominant: Clearing outputs fast-tracked to cap"
        )
        return clearer
    ...
    def apply_ledger_rules(
        ...
        ledger.warnings.append(
            "Sovereignty-Dominant: Ledger statuses fast-tracked to cap"
        )
        return ledger
