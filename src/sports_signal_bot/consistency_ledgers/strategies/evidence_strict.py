...
class EvidenceClearerStrictStrategy(BaseConsistencyLedgerStrategy):
    ...
    def apply_clearing_rules(self, clearer: EvidenceExchangeClearerRecord) -> EvidenceExchangeClearerRecord:
        clearer.warnings.append("Evidence-Strict: Evidence completeness and scope compatibility very strict")
        clearer.warnings.append("Evidence-Strict: Weak matches fast-tracked to review_only/no_safe")
        return clearer
