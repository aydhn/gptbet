...
class ContextConsistencyFirstStrategy(BaseConsistencyLedgerStrategy):
    ...
    def apply_federation_rules(self, federation: AlignmentCompilerFederationRecord) -> AlignmentCompilerFederationRecord:
        federation.warnings.append("Context-First: Weak evidence fast-tracked to review_only/no_safe")
        return federation
    ...
    def apply_clearing_rules(self, clearer: EvidenceExchangeClearerRecord) -> EvidenceExchangeClearerRecord:
        clearer.warnings.append("Context-First: Weak evidence fast-tracked to review_only/no_safe")
        return clearer
