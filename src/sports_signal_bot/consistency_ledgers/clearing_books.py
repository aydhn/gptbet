...
def build_clearing_book(exchange_family: str, scope_class: str) -> ClearingBookRecord:
...
def create_clearing_listing(
    ...
    return ClearingListingRecord(
        ...
        listing_family=input_record.family,
        source_ref=input_record.source_ref,
        source_family=input_record.source_family,
        supported_trace_families=input_record.trace_families,
        supported_audience_profiles=input_record.audience_profiles,
        evidence_completeness=input_record.completeness,
        currentness_state="current",
        caveat_refs=input_record.caveats,
...
def validate_clearing_compatibility(
    listing: ClearingListingRecord, request: ClearingRequestRecord
) -> Tuple[bool, List[str]]:
